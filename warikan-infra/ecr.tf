...
resource "aws_ecr_repository" "gspread_writer_repo" {
  name                 = "${var.app_name}-gspread-writer"
  image_tag_mutability = "IMMUTABLE"
...
resource "aws_ecr_lifecycle_policy" "gspread_writer_lifecycle" {
  repository = aws_ecr_repository.gspread_writer_repo.name
