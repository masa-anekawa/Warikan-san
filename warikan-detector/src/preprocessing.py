...
def preprocess_data_add_unknown(data):
    ...
    data_cleaned = extract_text_features(data_cleaned)
...
def extract_text_features(data, column_name="内容", n_features=1000):
...
def add_text_features(data, column_name="内容", n_features=1000):
    # Initialize the TF-IDF vectorizer
